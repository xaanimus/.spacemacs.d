...
`dotspacemacs/user-config' first."
  ...
  (setq-default omnisharp-server-executable-path
                ...
                omnisharp--curl-executable-path "/opt/local/bin/curl")
